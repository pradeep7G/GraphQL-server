...
const resolvers = {
  ...
  Mutation: {
    addBook: (root,args) => {
      if(!authors.filter(author => author.name).includes(args.author))
      {
        //if author of the book is not in the db we add him to authors list,then we add book to the list
    ...
    editAuthor: (root,args) => {
      const AuthorToUpdate = authors.find(author => args.name === author.name)
